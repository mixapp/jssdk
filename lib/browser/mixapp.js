    ...
    _createClass(Http, [{
        ...
        value: function _ajax(method, path, data, headers) {
            ...
            var promise = new Promise(function (resolve, reject) {
                ...
                var url = 'https://' + _this2.host + ':' + _this2.port + path + '?' + query;
...
var Process = exports.Process = function () {
    function Process(data, workspace, client) {
    ...
    _createClass(Process, [{
        ...
        value: function fetch() {
            ...
            return this._client.get('/v1/workspaces/' + this._workspace + '/processes/' + this.id).then(function (res) {
        ...
        value: function update(data) {
            ...
            return this._client.post('/v1/workspaces/' + this._workspace + '/processes/' + this.id, data).then(function (res) {
                for (var prop in res.result) {
        ...
        value: function createVariable(data) {
            return this._client.post('/v1/workspaces/' + this._workspace + '/processes/' + this.id + '/variables', data).then(function (res) {
                return res.result;
            });
        }
    }, {
        ...
        value: function updateVariable(name, data) {
            return this._client.post('/v1/workspaces/' + this._workspace + '/processes/' + this.id + '/variables/' + name, data).then(function (res) {
                return res.result;
            });
        }
    }, {
        ...
        value: function createConnector(data) {
            return this._client.post('/v1/workspaces/' + this._workspace + '/processes/' + this.id + '/connectors', data).then(function (res) {
                return res.result;
            });
        }
    }, {
        ...
        value: function updateConnector(id, data) {
            return this._client.post('/v1/workspaces/' + this._workspace + '/processes/' + this.id + '/connectors/' + id, data).then(function (res) {
                return res.result;
            });
        }
    }, {
...
},{"./client":1,"./workspace":6}],5:[function(require,module,exports){
'use strict';
